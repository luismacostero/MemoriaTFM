...
se vuelve a estabilizar el decrecimiento del número de tareas. \todo{Reescribir siguiente frase} Esto se
...
\item Cada \wt debe estar asignado a un núcleo único de la placa,
  ...
  \nanos, este comportamiento se consigue desactivando la opción contraria
		mediante el argumento \texttt{--disable-binding}.\todo{Esto es así?}
...
\todo{Si puedes, añade las unidades en el eje Y}.
...
al número máximo de tareas listas simultáneas \todo{No entiendo lo de simultáneas,
reescribe esta frase para que sea más clara} hasta el momento. Los
