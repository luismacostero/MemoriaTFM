...
\subsection{P6 y P7}
\rev{OJO: revisar esto con los experimentos reales para ver que no se está
  metiendo la pata muy hondo.}
...
apagar cores de manera dinámica se puede observar que: \comentario{quizás
  justificar con una figura}
\begin{enumerate}
...
\begin{figure}
  ...
  \begin{subfigure}{0.75\textwidth}
    \centering
    \fbox{\includegraphics[width=1\linewidth]{Plots/Modelos_consumo/apagadoJuno.eps}}
...
\vspace{0.5cm}
    ...
    \begin{subfigure}{0.75\textwidth}
      \centering
      \fbox{\includegraphics[width=1\linewidth]{Plots/Modelos_consumo/apagadoOdroid.eps}}
