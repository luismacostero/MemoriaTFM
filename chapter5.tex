...
que lo soporte. Como ejemplo del uso de esta técnica, destacar las
implementaciones comerciales de Intel para sus CPUs denominada \emph{Intel
...
destacar que este tipo de técnicas no sólo se puede realizar sobre
procesadores de propósito general, como puede ser la implementación de AMD
denominada \emph{AMD PowerTune} para GPUs y APUs.
...
frecuencias a las que cada cluster puede ejecutarse.
...
los resultados mostrados sean válidos para cualquier tarea.
...
internas del planificador), y actuar en función a la relación entre el
