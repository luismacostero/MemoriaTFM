...
\comentario{Quizás mover esta primera parte a 5.1.1} A la hora de aplicar
...
trabajo o no. Las líneas~\ref{s5:lst:p2-tamStep1}-\ref{s5:lst:p2-tamStep2}
...
energético mostrado en la tabla~\tab:mejora-gflops-p6}. Como se puede
