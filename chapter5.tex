...
Mientras que en la política P4 el impacto en la potencia instantánea media
no es muy elevado, en la política P5, desactivar el cluster \BIG tiene un
impacto muy significativo en ambas plataformas. Este hecho ocurría también
en las políticas anteriores, donde bajar la frecuencia al cluster \BIG
proporcionaba mejores resultados (en términos de potencia) que bajarla al
cluster \LITTLE. 


Aunque este resultado era esperado ya qeu según la gráfica de3 potencias,
los LITTLE consumen tan poco que es absurdo reducir mucho por ahí, si
embargo, los big consumen tanto que un ligero cambio es enorme para el
resultado final
