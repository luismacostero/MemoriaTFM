...
% \comentario{revisar este párrafo} Para ello, en primer lugar se describen
...
\todo{Aquí habría que decir que hay 3 variables que afectan al rendimiento y al consumo: tipo de núcleo, número de núcleos activos y frecuencia de los núcleos. Por lo tanto hay muchas formas de adaptar el rendimiento y el consumo a lo que necesite la aplicación y que vamos a explorar las principales.}
...
\comentario{tareas limitadas por el camino crítico / fase dominada por
  tareas críticas}
...
\comentario{ajuste a la carga de trabajo para LITTLE}
...
rendimiento, o no tienen un impacto significativo en la mejora de consumo.
...
\comentario{Desde el principio del punto (donde dice política 2) hasta aquí debería ser la introducción a las políticas de escalado de frecuencia, es decir, justo antes de la política 1.}
...
\comentario{Ajuste de carga de trabajo para big}
...
\comentario{Inhabilitación del cluster según la carga de trabajo}
...
\comentario{Este párrafo sería la introducción al 5.2.2}
...
\label{sec:p6}
\comentario{desactivación de núcleos}
...
\begin{lstlisting}[float,language=C++,caption={Fragmento de código para el apagado de cores de manera
...
\begin{figure}
  ...
  \begin{subfigure}{0.9\textwidth}
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{Plots/sched_results/P5_odroid.eps}}
    \caption*{Política P5}
  \end{subfigure}
  
  \begin{subfigure}{0.9\textwidth}
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{Plots/sched_results/P6_odroid.eps}}
    \caption*{Política P6}
  \end{subfigure}
