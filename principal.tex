...
%\documentclass[final, 12pt, oneside, a4paper]{class_diss}
\documentclass[final, 12pt, twoside]{class_diss}
...
\renewcommand{\lstlistlistingname}{Índice de listados}% List of Listings -> List of Algorithms
...
%%%%%%%%%%%%%%%%%%%%  MACROS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{macros}
%\newcommand{\BIG}{{\sc big}\xspace}
\newcommand{\BIG}{big\xspace}
\newcommand{\LITTLE}{{\sc LITTLE}\xspace}

\newcommand{\botlev}{{\sc Botlev}\xspace}
\newcommand{\wt}{{\em worker thread}\xspace}
\newcommand{\wts}{{\em worker threads}\xspace}
\newcommand{\odroid}{{\sc Odroid}\xspace}
\newcommand{\odroidxu}{{\sc Odroid-XU3}\xspace}
\newcommand{\juno}{{\sc Juno}\xspace}
\newcommand{\junodp}{{\sc Juno ARM Development Platform}\xspace}
...
\newcommand{\mercurium}{{\sc Mercurium}\xspace}
\newcommand{\extrae}{{\sc Extrae}\xspace}
%%%%%%%%%%%%%%%%%%%%  END MACROS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\bibliography{references,asymmetric,fran,energy,models}
